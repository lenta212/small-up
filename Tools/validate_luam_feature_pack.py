...
def main() -> int:
    ...
    assert_contains(rescue_agent_system, "allowAutoReturn: !hasPendingEvacuationTarget", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "pending evacuation target detected", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "holding shuttle forward after release of {FormatEntityRef(patient)}; pending evacuation target detected", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "StandbyAtAssignedShuttle(uid, rescue, htn, allowAutoReturn: !hasPendingEvacuationTarget)", "LuaMRescueAgentSystem")
