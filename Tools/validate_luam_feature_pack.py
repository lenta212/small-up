...
def main() -> int:
    ...
    for required_api in [
        ...
        "AibolitRadioPhraseBundles",
        "TryExtractRadioAiAddressedRequest",
        "HandleAibolitRadioRequest",
        "BuildAibolitRadioLinkedFallback",
        "BuildAibolitRadioPhraseBundles",
        "TryStartAibolitRadioGatewayReply",
        "RequestGatewayAibolitRadioAsync",
        "BuildGatewayAibolitRadioRequest",
        "PhraseBundles = BuildAibolitRadioPhraseBundles",
        "radio-style",
        "AllowedActions = [\"none\"]",
        "aibolit radio provider selected forbidden action",
    ...
    assert_contains(ai_director, "GetAiBasePhysicalRoleCount", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "LogisticsDrones", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "GuardDrones", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "ScoutDrones", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "MedicDrones", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "ServiceDrones", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "role doctrine missing", "LuaMSectorAiDirectorSystem")
    assert_contains(ai_director, "active {role.Role} service has no crew", "LuaMSectorAiDirectorSystem")
    ...
    for required_test_marker in [
        ...
        "AibolitRadioMarkerUsesConfiguredGatewayReply",
        "aibolit-radio",
        "phraseBundles",
        "radio-style",
        "current-status",
        "local-fallback-style",
        "\\\"allowedActions\\\":[\\\"none\\\"]",
        "Еду по текущему медсигналу",
    ...
    assert_contains(rescue_agent_system, "TryFindPriorityRescueOverride", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryGetActivePatientTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "UpdateTargetTrackingStatus(uid, rescue, htn);", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "targetTrack={rescue.LastTargetTrackingStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "target_lost:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "target_moved:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "distance > rescue.SearchRange", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route_clear: target={FormatEntityRef(target)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route_delayed: target={FormatEntityRef(target)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, 'rescue.LastTargetTrackingStatus.StartsWith("route_", StringComparison.Ordinal)', "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "TryTreatOrEvacuateTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ShouldEvacuateBeforeTreatment", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "IsThreatenedEvacuationTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "HasRescueTeamThreatPressure", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "HasRescueTeamOverwhelmingThreatPressure", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "team.NearbyHostiles >= rescue.OverwhelmingThreatHostileThreshold", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "team.NearbyCombatants >= rescue.OverwhelmingThreatCombatantThreshold", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "overwhelming-threat evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "unsafe-scene evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "BuildEvacuationReason", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.LastAutoEvacuationStatus = evacuationReason", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "condition-worsened evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "on-site treatment limited", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "heavy-damage evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "shuttle care required", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "score += 750f", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "!unsafeSceneEvacuation", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_component, "LastRedispatchStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastShuttleReturnStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_system, "HasPendingRescueTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryFindPendingRescueTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "HasPendingEvacuationTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "out var pendingTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "out var pendingReason", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryComp<MedibotComponent>(uid, out var medibot)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryFindRescueTarget(uid, rescue.SearchRange, rescue, medibot, out pendingTarget, completedTarget)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "pending-evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "pending-rescue", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "EntityUid? excludedTarget = null", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "candidate == excludedTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "if (!HasAutoAcquireAcuity(candidate, rescue))", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "HasAutoAcquireAcuity", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "damage.TotalDamage.Float() >= rescue.AutoAcquireMinDamage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "allowAutoReturn: !hasPendingRescueTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "holding shuttle forward after evacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "holding shuttle forward after skipping", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "holding shuttle forward after release", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "pending rescue target detected", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryReportRedispatchTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "redispatch={rescue.LastRedispatchStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "shuttleReturn={rescue.LastShuttleReturnStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "redispatch: source={source}; completed={FormatEntityRef(completedTarget)}", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "TryReleaseStabilizedPatientOnShuttle", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "AutoReleaseStabilizedPatients", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "AutoReleaseMaxDamage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "DefibrillatorSystem", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ItemToggleSystem", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryAutoDefibTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryAutoDefibDeadPatientOnShuttle", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryFindDefibrillatorItem", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "_itemToggle.TryActivate(defib, uid)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "_defibrillator.TryStartZap(defib, target, uid)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "defibrillation in progress", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "defibrillating onboard", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "autoDefib={rescue.LastAutoDefibStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "SubscribeLocalEvent<MobStateComponent, TargetDefibrillatedEvent>(OnTargetDefibrillated)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TrySendRescueStatusComms", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_component, "ArrivalReportedTarget", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastArrivalReportStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "TriageReportedTarget", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastTriageDecisionKey", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastTriageDecisionStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_system, "TryReportPatientArrival", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-arrival:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ClearArrivalReportTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryReportTriageDecision", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "triage-decision:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "GetTriageDecisionKey", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "BuildTriageDecisionMessage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "FormatMobStateForTriage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ClearTriageDecisionTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "_chat.TrySendInGameICMessage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "_radio.SendRadioMessage", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "MedicalRadioChannel", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "autoComms={rescue.LastAutoCommsKey}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescueAction={rescue.LastRescueActionStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboardCare={rescue.LastOnboardCareStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboardAction={rescue.LastOnboardActionStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "arrival={rescue.LastArrivalReportStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "triageDecision={rescue.LastTriageDecisionStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "defib-start:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "defib-success:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "defib-failed:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-onboard-dead:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ReportLivingPatientOnboardStatus", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-onboard-critical:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-onboard:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-hold-dead:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-hold-critical:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient-hold-treatment:", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "rescue-action:{step}:{patient}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.NextOnboardActionAt > now", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.NextRescueActionAt > now", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.OnboardActionCooldown", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.RescueActionCooldown", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"approach-patient"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"pull-start"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"deliver-bed"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"deliver-shuttle"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"treat-onsite"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"defib-approach"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient pull started", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "moving patient to shuttle bed", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "treating patient on scene", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "!IsOnAssignedShuttle(target, rescue)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"boarded"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"treating-critical"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"treating"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"reanimation"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"onboard-defib"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"onboard-treatment"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"release-ready"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, '"released"', "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient secured onboard", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "critical onboard treatment", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboard treatment and observation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboard treatment loop", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboard reanimation cycle", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "dead recovery defib cycle", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient stable, preparing release", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "patient released from shuttle care", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u0411\\u0435\\u0433\\u0443 \\u043a \\u043f\\u0430\\u0446\\u0438\\u0435\\u043d\\u0442\\u0443 {Name(target)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u041f\\u0430\\u0446\\u0438\\u0435\\u043d\\u0442 {Name(target)} \\u043d\\u0430 \\u043c\\u043d\\u0435", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u0422\\u0430\\u0449\\u0443 {Name(target)} \\u043d\\u0430 \\u0431\\u043e\\u0440\\u0442", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u041b\\u0435\\u0447\\u0443 {Name(target)} \\u043d\\u0430 \\u043c\\u0435\\u0441\\u0442\\u0435", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboard-care: patient={FormatEntityRef(patient)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "critical; treatment continuing", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "dead recovery; defib cycle pending", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "release-ready; {status}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "onboard-care released: patient={FormatEntityRef(patient)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u041f\\u0430\\u0446\\u0438\\u0435\\u043d\\u0442 {Name(target)} \\u043d\\u0430\\u0439\\u0434\\u0435\\u043d", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u0422\\u0440\\u0438\\u0430\\u0436 {name}:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "dead-recovery", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "TryHoldRouteBlockedEvacuation", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "HasRescueTeamRoutePressure", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryGetActiveDeliveryGoal", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryRerouteBlockedDeliveryTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryFallbackToShuttleExtraction", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "TryFallbackToShuttleExtraction(uid, target, rescue, htn, progressGoal)", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "hold-position route blocked", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route-blocked-hold:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route-blocked-reroute:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route-blocked-help:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "route-blocked-extract:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "rescue.AssignedPatientStrap = null;", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "fallback extraction after blocked route", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "fallback-extraction-waiting", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "requesting route help", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "routeHold={rescue.LastRouteBlockHoldStatus}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u041c\\u0430\\u0440\\u0448\\u0440\\u0443\\u0442 \\u044d\\u0432\\u0430\\u043a\\u0443\\u0430\\u0446\\u0438\\u0438 \\u0437\\u0430\\u0431\\u043b\\u043e\\u043a\\u0438\\u0440\\u043e\\u0432\\u0430\\u043d", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "falling back to shuttle extraction", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_team_system, "evacFormation={team.LastEvacuationFormationStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crewHelpAck={team.LastCrewHelpAcknowledgementStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "handoff={team.LastHandoffDigest}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "after-action record #", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRecordRescueAfterAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HandoffPhaseHoldSeconds", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "handoff complete:", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_team_system, "SelectTriageCoverRole", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryFindEscortByRole", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildTriageCoverLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "triage-cover:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "triageCover={team.LastTriageCoverStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "\\u041f\\u0435\\u0440\\u0438\\u043c\\u0435\\u0442\\u0440 \\u0441\\u0442\\u0430\\u0431\\u0438\\u043b\\u0435\\u043d", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_agent_component, "OnboardCareTarget", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastOnboardCareStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastOnboardActionStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastRescueActionStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "OnboardActionCooldown = 10f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "RescueActionCooldown = 6f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastOnboardActionKey", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "NextOnboardActionAt", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastRescueActionKey", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "NextRescueActionAt", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastTargetTrackingStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoAcquireTargets", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoAcquireMinDamage = 5f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "EvacuateTargetsToShuttle = true", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "RecoverDeadPatientsToShuttle = true", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "AutoReleaseStabilizedPatients = true", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoTreatWithCarriedItems = true", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoDefibDeadPatients = true", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "EvacuateWhenSceneThreatened = true", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "ThreatEvacuationMinDamage = 5f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "OverwhelmingThreatHostileThreshold = 3", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "OverwhelmingThreatCombatantThreshold = 4", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoReleaseMaxDamage = 5f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoReleaseRange = 1.5f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "TargetStallSeconds = 20f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "HoldPositionOnBlockedEvacuation = true", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "RouteBlockHoldSeconds = 4f", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "AutoDefibCooldown = 8f", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "AutoCommsCooldown = 10f", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "NextAutoDefibAttempt", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "NextAutoCommsAt", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "LastAutoDefibStatus", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastAutoCommsKey", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_agent_component, "RouteBlockHoldTarget", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "RouteBlockHoldGoal", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "RouteBlockHelpRequested", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "LastRouteBlockHoldStatus", "LuaMRescueAgentComponent")
    ...
    assert_contains(rescue_team_component, "DutyUpdatedAt", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "PendingDuty", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "PendingDutySince", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "DutyTransitions", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "LastSortiePlanStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "TriageCoverConfirmedPatient", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastTriageCoverDecisionKey", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastTriageCoverStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "NextTriageCoverConfirmAt", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastAnnouncedPhase", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastAnnouncedSomberScene", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastPhaseAnnouncementStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "NextPhaseAnnouncementAt", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastSharedSpeechStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "NextSharedSpeechAt", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastTeamLine", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastTeamLineKey", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "RecentTeamLines", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LuaMRescueTeamSpeechMemoryEntry", "LuaMRescueTeamSpeechMemoryEntry")
    assert_contains(rescue_team_component, "LastReturnOrExtractReasonStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastEvacuationFormationStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastCrewHelpAcknowledgementStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastThreatNeutralizedTarget", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastThreatNeutralizedBy", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastThreatNeutralizedStatus", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "NextThreatNeutralizedReportAt", "LuaMRescueTeamComponent")
    ...
    assert_contains(rescue_team_component, "CrowdTarget", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "RouteBlockerTarget", "LuaMRescueTeamComponent")
    ...
    assert_contains(rescue_team_component, "LastDutyActionStatus", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "LastWeaponReadinessStatus", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "LastCrewHelpStatus", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "LastCrewHelpKey", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "NextCrewHelpRequestAt", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "DutyActions", "LuaMRescueEscortComponent")
    assert_contains(rescue_team_component, "NextDutyActionAt", "LuaMRescueEscortComponent")
    ...
    assert_contains(rescue_team_component, "LastHandoffPatient", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastHandoffRecord", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "LastHandoffDigest", "LuaMRescueTeamComponent")
    assert_contains(rescue_team_component, "HandoffRecords", "LuaMRescueTeamComponent")
    ...
    assert_contains(rescue_team_system, "TryRecordRescueHandoff", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "handoff record #", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "playerContribution=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'playerContribution = $"{playerContribution}, {crewHelpAcknowledgement}"', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crewHelpAck={team.LastCrewHelpAcknowledgementStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "team.LastCrewHelpAcknowledgementStatus = crewHelpAcknowledgement", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildCrewHelpAcknowledgementStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TrySayCrewHelpAcknowledgement", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crew-help-ack: route clear; contribution recorded", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "ContainsCrewHelpRequest", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasClearedCrewHelpRoute", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u042d\u043a\u0438\u043f\u0430\u0436, \u043f\u043e\u043c\u043e\u0449\u044c \u0437\u0430\u0441\u0447\u0438\u0442\u0430\u043d\u0430", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "teamStatus=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "handoff={team.LastHandoffRecord}", "LuaMRescueTeamSystem")
    sector_memory = (ROOT / "Content.Server/_LuaM/Sector/LuaMSectorMemoryComponent.cs").read_text(encoding="utf-8")
    sector_story_system = (ROOT / "Content.Server/_LuaM/Sector/LuaMSectorStorySystem.cs").read_text(encoding="utf-8")
    ...
    ai_logistics_ship_component = (ROOT / "Content.Server/_LuaM/Sector/LuaMAiLogisticsShipComponent.cs").read_text(encoding="utf-8")
    ai_logistics_ship_system = (ROOT / "Content.Server/_LuaM/Sector/LuaMAiLogisticsShipSystem.cs").read_text(encoding="utf-8")
    ai_mining_drone_component = (ROOT / "Content.Server/_LuaM/Sector/LuaMAiMiningDroneComponent.cs").read_text(encoding="utf-8")
    ...
    assert_contains(sector_memory, "RescueMedicalOperations", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastRescueMedicalStatus", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastRescueMedicalFollowUpPending", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastRescueCooldownSequence", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "NextRescueDispatchAllowedAt", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastRescueCooldownStatus", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "BehaviorMode", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "BehaviorFocusResource", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "BehaviorDirective", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastBehaviorTrigger", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "FactionId", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "FactionName", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "FactionCharter", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "AutonomyModel", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "ImprovementLoopState", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastImprovementFocus", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LastImprovementFinding", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "ImprovementRevision", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "RoleDoctrine", "LuaMSectorMemoryComponent")
    assert_contains(sector_memory, "LuaMAiBaseRoleEntry", "LuaMSectorMemoryComponent")
    assert_contains(sector_story_system, "TryRecordRescueAfterAction", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "UpdateAiBaseMedicalStatus", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "BuildAiBaseMedicalStatusText", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "UpdateAiBaseRescueCooldown", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "RefreshAiBaseBehavior", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "SelectAiBaseBehaviorDecision", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "EnsureAiBaseFactionDefaults", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "RefreshAiBaseDerivedState", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "BuildAiBaseRoleDoctrine", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "BuildAiBaseRoleDoctrineSummary", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "SelectAiBaseImprovementDecision", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LuaMAiBasePersistedRoleEntry", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "Faction: {state.FactionName}", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "Improvement loop: state={state.ImprovementLoopState}", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "medical-followup", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "Behavior: mode={state.BehaviorMode}", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "TryGetActiveRescueCooldown", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "IsRescueCooldownActive", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "RescueAfterActionCooldownSeconds", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "RescueAfterActionBlockedCooldownSeconds", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "Medical status:", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LuaMAiBasePersistedState", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LastRescueMedicalFollowUpPending", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LastRescueCooldownStatus", "LuaMSectorStorySystem")
    ...
    assert_contains(sector_story_system, "BehaviorMode = state.BehaviorMode", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LastBehaviorTrigger = state.LastBehaviorTrigger", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "FactionId = state.FactionId", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "AutonomyModel = state.AutonomyModel", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "ImprovementLoopState = state.ImprovementLoopState", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "RoleDoctrine = state.RoleDoctrine", "LuaMSectorStorySystem")
    assert_contains(sector_story_system, '"Rescue"', "LuaMSectorStorySystem")
    assert_contains(sector_story_system, "LuaMSectorPersistedRescueAfterAction", "LuaMSectorStorySystem")
    ...
    assert_contains(sector_story_test, "RescueMedicalOperations", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "LastRescueMedicalStatus", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "LastRescueCooldownStatus", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "FactionId, Is.EqualTo(\"luam-ai-contour\")", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "RoleDoctrine.Any", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "ImprovementLoopState, Is.EqualTo(\"medical-followup\")", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "medic:primary/active", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, 'BehaviorMode, Is.EqualTo("medical-followup")', "LuaMSectorStoryTest")
    assert_contains(sector_story_test, 'BuildCrewManifest("builder", "Baeg", "medical-followup", "medicine")', "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "doctrine bootstrap/base", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "TryGetActiveRescueCooldown", "LuaMSectorStoryTest")
    assert_contains(sector_story_test, "follow-up pending", "LuaMSectorStoryTest")
    assert_contains(ai_logistics_ship_component, "BaseBehaviorMode", "LuaMAiLogisticsShipComponent")
    assert_contains(ai_logistics_ship_component, "BaseBehaviorFocusResource", "LuaMAiLogisticsShipComponent")
    assert_contains(ai_logistics_ship_component, "BaseBehaviorDirective", "LuaMAiLogisticsShipComponent")
    assert_contains(ai_logistics_ship_system, "BuildCrewProfile(", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_logistics_ship_system, "ApplyBehaviorToManifest", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_logistics_ship_system, "RoleForBehaviorFocus", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_logistics_ship_system, "NormalizeBehaviorMode", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_logistics_ship_system, "BuildCrewDirective(role, drone.DisplayName, drone.BaseBehaviorMode, drone.BaseBehaviorFocusResource)", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_logistics_ship_system, "doctrine {logistics.BaseBehaviorMode}/{logistics.BaseBehaviorFocusResource}", "LuaMAiLogisticsShipSystem")
    assert_contains(ai_mining_drone_component, "BaseBehaviorMode", "LuaMAiMiningDroneComponent")
    assert_contains(ai_mining_drone_component, "BaseBehaviorFocusResource", "LuaMAiMiningDroneComponent")
    ...
    assert_contains(rescue_team_system, "EscortDutyHoldSeconds", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "UpdateEscortDutySelection", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "CommitEscortDuty", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsUrgentEscortDuty", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildEscortDutyStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunEscortDutyAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortCombatStorageSlotPriority", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HandsSystem", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "InventorySystem", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "SharedStorageSystem", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "GunComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryEnsureEscortWeaponReady", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsEscortCombatReadinessDuty", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TrySelectHeldEscortWeapon", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryTakeStoredEscortWeapon", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryMakeRoomForEscortWeapon", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryResolveEscortStorageSlot", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TrySelectStoredEscortWeapon", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasComp<GunComponent>(item)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "weapon={escort.LastWeaponReadinessStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "weapon-ready held", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "no empty hand for stored weapon", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stowed {FormatEntityRef(held)}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "CrewHelpRequestCooldownSeconds = 12", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRequestCrewHelp", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crew-help:{key}; {status}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crewHelp={escort.LastCrewHelpStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "escort.NextCrewHelpRequestAt > now", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "mark-safe-path", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "open-route:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "clear-blocker:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "hold-corridor:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "remove-blocker:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "drop-blocker:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "step-away", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-needed:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-moving:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-coordinate:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-ready:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-escort:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "stretcher-blocked:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "open route around non-pullable", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "manual removal needed", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "crowd control warning", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "patient assist pull blocked", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "moving patient {FormatEntityRef(patientUid)} to shuttle", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "var followTarget = GetEscortFollowTarget(uid, escort, duty);", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "GetPatientSupportFollowTarget", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsEscortPullingPatient(uid, patient)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "return shuttleAnchor ?? shuttle ?? leader ?? patient;", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "patient-assist escorting", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "UpdateEvacuationFormationStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildEvacuationFormationStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "phase is LuaMRescueTeamPhase.PrepareEvacuation or LuaMRescueTeamPhase.EvacuateToShuttle", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "evac-formation:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "kostyl=patient-lead", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "tourniquet=corridor-control", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "zaslon=threat-side", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "route=shuttle-unassigned", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "pressure={pressure}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunThreatScreenAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunClearRouteAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "RouteBlockerDropoffDistance = 3.5f", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "RouteBlockerReleaseDistance = 3.25f", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryFinishClearRouteBlockerAtDropoff", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsRouteBlockerClearOfRescueCorridor", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsRouteBlockerWithinRescueCorridor", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TrySetClearRouteDropoffTarget", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "GetClearRouteDropoffDirection", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "puller.Pulling != blockerUid", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "_pulling.TryStopPull(blockerUid, pullable, uid)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "blockerXform.Coordinates.Offset(direction * RouteBlockerDropoffDistance)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "_npc.SetBlackboard(uid, NPCBlackboard.FollowTarget, dropoff, htn)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "clear-route dragging", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "clear-route dropped", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "clearance {distance:0.0}/{RouteBlockerReleaseDistance:0.0}m", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunPatientAssistAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunCrowdControlAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryConfirmTriageCover", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "SelectTriageCoverRole", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryFindEscortByRole", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildTriageCoverLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "triage-cover:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "triageCover={team.LastTriageCoverStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TeamPhaseAnnouncementCooldownSeconds", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TeamSharedSpeechCooldownSeconds = 6", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TeamRecentLineMemorySeconds", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TeamRecentLineMemoryLimit", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TrySayTeamPhaseLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryReserveTeamSpeech", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "SetTeamSharedSpeechStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "PruneTeamSpeechMemory", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "RecordTeamSpeechLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "NormalizeTeamLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "shared-speech repeated line suppressed", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "shared-speech waiting: {key}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "shared-speech:{key}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryBuildTeamPhaseLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryBuildTeamPhaseLine(phase, somberScene", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "phase-bark:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "phase-bark waiting shared speech", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "somber={somberScene}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "phaseBark={team.LastPhaseAnnouncementStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "speech={team.LastSharedSpeechStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "lastLine={team.LastTeamLineKey}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "recentLines={team.RecentTeamLines.Count}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryGetEscortLeaderTeam", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'var key = $"duty:{FormatRole(escort.Role)}:{FormatDuty(duty)}"', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryReserveTeamSpeech(uid, team, key, now, out var speechStatusChanged, line)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "Dirty(leader, team)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "cooldown={TeamSharedSpeechCooldownSeconds:0}s", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsSomberTeamScene", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsSomberEscortScene", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsDeadPatient", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasSomberStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "GetSomberDutyLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "GetDutyLine(escort.Role, duty, IsSomberEscortScene(escort))", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'status.Contains("dead", StringComparison.OrdinalIgnoreCase)', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'status.Contains("failed", StringComparison.OrdinalIgnoreCase)', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'status.Contains("aborted", StringComparison.OrdinalIgnoreCase)', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, 'status.Contains("blocked", StringComparison.OrdinalIgnoreCase)', "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u0412\u044b\u0435\u0437\u0434 \u043f\u0440\u0438\u043d\u044f\u0442. \u0420\u0430\u0431\u043e\u0442\u0430\u0435\u043c \u0431\u0435\u0437 \u043b\u0438\u0448\u043d\u0438\u0445 \u0440\u0435\u043f\u043b\u0438\u043a", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u0411\u0435\u0440\u0443 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0443 \u043f\u0430\u0446\u0438\u0435\u043d\u0442\u0430", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u0423\u0433\u0440\u043e\u0437\u0430 \u043d\u0430 \u043c\u043d\u0435", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "ThreatNeutralizedReportCooldownSeconds = 6", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryReportThreatNeutralized", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "SetThreatNeutralizedStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildThreatNeutralizedLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "team.LastThreatNeutralizedTarget == threatUid", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "threat-neutralized:", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "threat-screen target neutralized and reported", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "threatClear={team.LastThreatNeutralizedStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "LuaMRescueTeamPhase.EvacuateToShuttle", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "LuaMRescueEscortRole.Kostyl", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "LuaMRescueEscortRole.Tourniquet", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortThreatScreenRange = 7f", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortThreatLeashRange = 8.5f", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "NPCBlackboard.CurrentOrderedTarget", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "_combatMode.SetInCombatMode(uid, true, combat)", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_team_system, "ShouldEscortAssistPatientPull", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryStartPull", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortDutyActionIntervalSeconds", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortDutyActionRange", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EscortPatientAssistRange", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "patient-assist", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "dutyAge=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "dutyTransitions=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "focus=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "action=", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "blockerTarget=", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_team_system, "GetActiveRescuePatient", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "var patient = GetActiveRescuePatient(rescue);", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "escort.Patient = GetActiveRescuePatient(rescue);", "LuaMRescueTeamSystem")
    assert_not_contains(rescue_team_system, "?? team.Patient", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "LuaMRescueTeamPhase.ReturnOrExtract", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "plan return-to-shuttle: extraction phase", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "returning or extracting", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildReturnOrExtractReasonStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildReturnOrExtractLine", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "returnReason={team.LastReturnOrExtractReasonStatus}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "returning or extracting: {returnOrExtractReason}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "reason=route-blocked", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "reason=unsafe-scene", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "reason=failed-or-aborted", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "reason=dead-recovery", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "reason=handoff-complete", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasRouteBlockedStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasUnsafeStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasFailedStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasDeadStatus", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u041e\u0442\u0445\u043e\u0434\u0438\u043c: \u043c\u0430\u0440\u0448\u0440\u0443\u0442 \u0437\u0430\u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u0430\u043d", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u041e\u0442\u0445\u043e\u0434\u0438\u043c: \u0437\u043e\u043d\u0430 \u043d\u0435 \u0434\u0435\u0440\u0436\u0438\u0442\u0441\u044f", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, r"\u041e\u0442\u0445\u043e\u0434\u0438\u043c: \u0437\u0430\u0434\u0430\u0447\u0430 \u0441\u043e\u0440\u0432\u0430\u043d\u0430", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryRunReturnToShuttleAction", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "TryReleaseReturnPull", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "puller.Pulling is not { Valid: true } pulled", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "_pulling.TryStopPull(pulled, pullable, uid)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "return-to-shuttle released pull", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "return-to-shuttle moving to", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "return-to-shuttle ready at", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "return-to-shuttle no shuttle target", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_team_system, "IsPrioritySyntheticThreat", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "IsSyntheticRescueActor", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasImmediateRescueSyntheticControl", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "LuaMAiDroneTaskComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "DroneControlComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "AiRemoteControllerComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "SiliconComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BorgChassisComponent", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "_tag.HasTag(candidate, BotTag)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "HasImmediateRescueSyntheticControl(candidate);", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "var syntheticThreatCount = 0;", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "EntityUid? syntheticThreatTarget = null;", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "syntheticThreatCount++;", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "syntheticThreatTarget = candidate;", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "ValidOrNull(syntheticThreatTarget) ?? ValidOrNull(threatTarget)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "BuildSceneSummary(hostileCount, syntheticThreatCount, combatantCount, crowdCount, blockerCount)", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "threat synthetic={syntheticThreats}", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "threat-screen engaging synthetic", "LuaMRescueTeamSystem")
    assert_contains(rescue_team_system, "immediate synthetic cleanup", "LuaMRescueTeamSystem")
    ...
    assert_contains(rescue_agent_system, "RecordRescueHandoff", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "stabilized on site; no evacuation required", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "secured onboard; return route requested", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_agent_system, "BuildHandoffTriageCoverSummary", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "triageCover={triageCover}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "LastTriageCoverStatus", "LuaMRescueAgentSystem")
    ...
    assert_contains(rescue_shuttle_system, "LuaMSectorStorySystem", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "_sectorStory.TryGetActiveRescueCooldown", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "Rescue dispatch cooldown active", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "Use --death-signal for a confirmed death signal", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "SubscribeLocalEvent<MobStateChangedEvent>(OnMobStateChanged)", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "TryDispatchAutomaticDeathSignal(ev.Target)", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "TryDispatchAutomaticCriticalSignal(ev.Target)", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "ev.NewMobState != MobState.Critical", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "HasComp<ActorComponent>(target)", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "AutomaticDeathSignalCooldownSeconds", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "AutomaticCriticalSignalCooldownSeconds", "LuaMRescueShuttleSystem")
    ...
    assert_contains(rescue_shuttle_system, "bool deathSignal", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "Death signal dispatch requires a rescue agent so Aibolit can report who it is flying to.", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "Death signal dispatch requires target=<entity|player> so Aibolit can report who it is flying to.", "LuaMRescueShuttleSystem")
    ...
    assert_contains(rescue_shuttle_system, "\\u041a\\u0440\\u0438\\u0442\\u0438\\u0447\\u0435\\u0441\\u043a\\u0438\\u0439 \\u043c\\u0435\\u0434\\u0441\\u0438\\u0433\\u043d\\u0430\\u043b \\u043f\\u0440\\u0438\\u043d\\u044f\\u0442", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "\\u0412\\u044b\\u043b\\u0435\\u0442\\u0430\\u044e \\u043a \\u043f\\u0430\\u0446\\u0438\\u0435\\u043d\\u0442\\u0443 {targetName}", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "MarkDeathSignalDispatchReported", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "MarkCriticalSignalDispatchReported", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, "rescue.DeathSignalDispatchReported = true", "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, 'rescue.LastAutoCommsKey = $"death-signal-dispatch:{target}"', "LuaMRescueShuttleSystem")
    assert_contains(rescue_shuttle_system, 'rescue.LastAutoCommsKey = $"critical-signal-dispatch:{target}"', "LuaMRescueShuttleSystem")
    assert_contains(rescue_agent_component, "DeathSignalTarget", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_component, "DeathSignalDispatchReported", "LuaMRescueAgentComponent")
    assert_contains(rescue_agent_system, "TryReportDeathSignalDispatch", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "death-signal-dispatch:", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "deathSignal={FormatEntityRef(rescue.DeathSignalTarget)}", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "mobState.CurrentState != MobState.Dead", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "ClearDeathSignalTarget", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u041c\\u0435\\u0434\\u0441\\u0438\\u0433\\u043d\\u0430\\u043b \\u0441\\u043c\\u0435\\u0440\\u0442\\u0438 \\u043f\\u0440\\u0438\\u043d\\u044f\\u0442", "LuaMRescueAgentSystem")
    assert_contains(rescue_agent_system, "\\u0412\\u044b\\u043b\\u0435\\u0442\\u0430\\u044e \\u043a \\u043f\\u0430\\u0446\\u0438\\u0435\\u043d\\u0442\\u0443 {Name(target)}", "LuaMRescueAgentSystem")
