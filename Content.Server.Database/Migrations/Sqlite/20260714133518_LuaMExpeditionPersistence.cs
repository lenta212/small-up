    ...
    public partial class LuaMExpeditionPersistence : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_manifests_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    campaign_id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    expedition_id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    seed_bits = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_checkpoints_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    state_payload = table.Column<byte[]>(type: "BLOB", nullable: false),
                    payload_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    status = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    committed_at_utc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    quarantine_reason = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_checkpoint_luam_expedition_manifest_lua_m_expedition_manifest_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_regions_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    manifest_id = table.Column<long>(type: "INTEGER", nullable: false),
                    ...
                    max_x = table.Column<int>(type: "INTEGER", nullable: false),
                    max_y = table.Column<int>(type: "INTEGER", nullable: false),
                    biome = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    scenario_tag = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    danger_budget = table.Column<int>(type: "INTEGER", nullable: false),
                    discovered_at_utc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    is_depleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    edge_format_version = table.Column<int>(type: "INTEGER", nullable: false),
                    edge_payload = table.Column<byte[]>(type: "BLOB", nullable: false),
                    edge_payload_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    revision = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_region_luam_expedition_manifest_lua_m_expedition_manifest_id",
                        column: x => x.manifest_id,
                        principalTable: "luam_expedition_manifest",
                        principalColumn: "lua_m_expedition_manifests_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_sites_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    manifest_id = table.Column<long>(type: "INTEGER", nullable: false),
                    site_id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    kind = table.Column<int>(type: "INTEGER", nullable: false),
                    prototype_id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    unique_scope = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ...
                    state_payload = table.Column<byte[]>(type: "BLOB", nullable: false),
                    state_payload_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    revision = table.Column<long>(type: "INTEGER", nullable: false),
                    discovered_at_utc = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_site_luam_expedition_manifest_lua_m_expedition_manifest_id",
                        column: x => x.manifest_id,
                        principalTable: "luam_expedition_manifest",
                        principalColumn: "lua_m_expedition_manifests_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_deltas_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    region_id = table.Column<long>(type: "INTEGER", nullable: false),
                    region_revision = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_delta_luam_expedition_region_lua_m_expedition_region_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_entity_snapshots_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    region_id = table.Column<long>(type: "INTEGER", nullable: false),
                    stable_entity_id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    source_instance_id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_entity_snapshot_luam_expedition_region_lua_m_expedition_region_id",
                        column: x => x.region_id,
                        principalTable: "luam_expedition_region",
                        principalColumn: "lua_m_expedition_regions_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    lua_m_expedition_tombstones_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    region_id = table.Column<long>(type: "INTEGER", nullable: false),
                    site_row_id = table.Column<long>(type: "INTEGER", nullable: true),
                    stable_object_id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    source_instance_id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    kind = table.Column<int>(type: "INTEGER", nullable: false),
                    region_revision = table.Column<long>(type: "INTEGER", nullable: false),
                    actor_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_luam_expedition_tombstone_luam_expedition_region_lua_m_expedition_region_id",
                        column: x => x.region_id,
                        principalTable: "luam_expedition_region",
                        principalColumn: "lua_m_expedition_regions_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_luam_expedition_tombstone_luam_expedition_site_lua_m_expedition_site_id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                CREATE TEMP TABLE __luam_expedition_downgrade_guard (
                    value INTEGER NOT NULL CHECK (value = 0)
                );
                INSERT INTO __luam_expedition_downgrade_guard (value)
                SELECT 1 WHERE EXISTS (SELECT 1 FROM luam_expedition_manifest);
                DROP TABLE __luam_expedition_downgrade_guard;
                """);
