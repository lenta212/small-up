...
notekeeper-hint = Короткие личные заметки, сохранённые в этом КПК.
notekeeper-empty = Заметок пока нет.
notekeeper-placeholder = Введите заметку и нажмите Enter…
notekeeper-remove = Удалить заметку
news-read-program-name = Новости станции
crew-manifest-program-name = Манифест экипажа
crew-manifest-cartridge-loading = Загрузка...
net-probe-program-name = Зонд сетей
net-probe-hint = Недавно обнаруженные сетевые устройства.
net-probe-empty = Просканируйте устройство, чтобы добавить его в список.
...
log-probe-no-device = Просканируйте устройство, чтобы загрузить журнал доступа.
log-probe-empty = В журнале этого устройства нет записей.
